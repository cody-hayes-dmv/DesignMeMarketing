...
async function main() {
  ...
  const onboardingTasks = [
    ...
    {
      title: "Keyword and map pack research",
      description: null,
      category: "Research",
      priority: "high",
      estimatedHours: 1,
    ...
    {
      title: "12-month content building plan",
      description: null,
      category: "Content",
      priority: "medium",
      estimatedHours: 1,
    ...
    {
      title: "Update all GBP categories",
      description: null,
      category: "GBP",
      priority: "medium",
      estimatedHours: 1,
    ...
    {
      title: "Complete entire GBP profile",
      description: null,
      category: "GBP",
      priority: "high",
      estimatedHours: 1,
